...
def button_click(number):
    current = e.get()
    e.delete(0,END)
    e.insert(0,str(current) + str(number)) #concatenation
...
button_multiplication = Button(root,text="*",padx="39",pady="20",command=button_multiply)
button_equall = Button(root,text="=",padx="91",pady="20",command=button_equal)
button_clean = Button(root,text="clear",padx="79",pady="20",command=button_clear)
...
button_clean.grid(row=4,column=1,columnspan=2)
